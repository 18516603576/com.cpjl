...
var sb_cfg = {
	...
	<div id="top">
		<div class="left">
			...
			<a  id="thisPage" href="${pageContext.request.contextPath}/articlecat/list?cName=${cName}"  class="on">栏目列表</a>
			<a href="javascript:new openWin({document:window.parent.document,width:'90%',height:'90%',title:'添加栏目',src:'${pageContext.request.contextPath}/articlecat/insert?deviceid=${entity.deviceid }'}).start()" >添加栏目</a>		
		</div>
		<div class="right">
...
<script type="text/javascript">
 ...
 //删除操作
		...
		$(document).delegate("a.del","click",function(){ 
 			 init1.doo(false,'',$(this),'${pageContext.request.contextPath}/articlecat/delete','确定删除当前记录吗？',false);
		});
		...
		$(document).delegate("a.update","click",function(){ 
			 ...
			 new openWin({document:window.parent.document,width:'90%',height:'90%',title:'修改栏目',src:'${pageContext.request.contextPath}/articlecat/update?id='+id}).start();
		});
