...
<script>
  var bf_cfg = {
	      ...
	      ,"url":"${entity.url}"
             ...
             <form name="form1" id="form1"  method="post" action="${pageContext.request.contextPath}/video/insertDo "> 		 
...
<script language="JavaScript">
 ...
 <script>
	...
	<script> 
	   ...
	   var submitUrl = "${pageContext.request.contextPath}/upload/thumbnail?width=500&height=500";  
