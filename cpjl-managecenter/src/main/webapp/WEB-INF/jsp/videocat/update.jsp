...
var sb_cfg = {
		...
		,"typeList" : [{"id":3,"name":"图片列表"}]
		,"type":"${entity.type}"
}
</script>
<form name="form1" id="form1"  method="post" action="${pageContext.request.contextPath}/videocat/updateDo"> 
      ...
      <script>
    	 //分类加载
		  ...
		  function initParentid(){
			     ...
			     var videocatList = sb_cfg.videocatList;
